...
def reward_function(params):
    ...
    ##################################New addition: keep wheels on the track#############################################
    ...
    #################################New addition: penalize for speed rate and progress rate####################################################
    # penalize for slow speed rate
    speed_rate = speed / MAX_SPEED
    progress_rate = progress / steps
    reward *= speed_rate
    # reward = reward * (speed_rate ** 2)
    reward *= progress_rate
    ...
    if progress > 70:
        ...
        reward *= 0.7  # completion % is not good
    ...
    ################################New addition: keep wheels on track######################################
    ...
    #############################New addition: distance from each border######################################
    ...
    if distance_from_border >= 0.05:
        ...
        reward -= 5.0    # Low reward if too close to the border or goes off the track
